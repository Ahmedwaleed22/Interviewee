    ...
    <div className="h-screen w-full bg-[#0a0a0a] flex flex-col relative text-white overflow-hidden font-sans selection:bg-blue-500/30">
      ...
      <div className="h-24 px-8 flex items-center justify-between shrink-0 relative z-20">
        ...
        <div className="flex items-center gap-3 min-w-[240px] justify-end">
            ...
            <button className="p-3 hover:bg-white/5 rounded-full transition-colors relative text-gray-400 hover:text-white">
                <MessageSquare className="w-5 h-5" />
                <span className="absolute top-2 right-2 w-2 h-2 bg-blue-500 rounded-full ring-2 ring-[#0a0a0a]"></span>
            </button>
        </div>
      </div>
    </div>
